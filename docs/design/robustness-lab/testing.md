...
鲁棒性实验室已完成本地开发自动门禁：既有 97 项基线未放宽，新增配方、随机性、算子、链、BER、诊断、报告、隐私、Document、组合根和 Headless View 测试。2026-08-30 最后一次门禁为 Debug 122/122、Release 122/122，均零跳过；两次构建均零警告、零错误。
...
- 中文解释：帮助目录与全部 18 种领域算子的稳定 ID 一一对应；每项说明、注意事项、参数唯一性、默认参数一致性以及切换攻击/参数后的派生展示均有断言。
