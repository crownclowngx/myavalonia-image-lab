...
internal interface IImagePerturbationOperator
{
    ...
    ValueTask<PixelImage> ApplyAsync(PixelImage source, PerturbationParameters parameters, PerturbationExecutionContext trial, CancellationToken cancellationToken);
}
    ...
    where TParameters : PerturbationParameters
{
    ...
    public ValueTask<PixelImage> ApplyAsync(PixelImage source, PerturbationParameters parameters, PerturbationExecutionContext trial, CancellationToken cancellationToken)
    {
    ...
    protected abstract PixelImage Apply(PixelImage source, TParameters parameters, PerturbationExecutionContext trial, CancellationToken cancellationToken);
}
