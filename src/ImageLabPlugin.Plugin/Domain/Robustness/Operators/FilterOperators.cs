...
internal sealed class GaussianBlurOperator : SynchronousPerturbationOperator<GaussianBlurParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, GaussianBlurParameters p, DeterministicTrialContext trial, CancellationToken token) =>
...
internal sealed class MedianBlurOperator : SynchronousPerturbationOperator<MedianBlurParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, MedianBlurParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class UnsharpMaskOperator : SynchronousPerturbationOperator<UnsharpMaskParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, UnsharpMaskParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
