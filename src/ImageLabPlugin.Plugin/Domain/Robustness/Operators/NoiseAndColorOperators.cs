...
internal sealed class DeterministicPixelOperator : SynchronousPerturbationOperator<DeterministicPixelParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, DeterministicPixelParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class GaussianNoiseOperator : SynchronousPerturbationOperator<GaussianNoiseParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, GaussianNoiseParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class SaltPepperNoiseOperator : SynchronousPerturbationOperator<SaltPepperParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, SaltPepperParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class BrightnessOperator : SynchronousPerturbationOperator<BrightnessParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, BrightnessParameters p, DeterministicTrialContext trial, CancellationToken token) =>
...
internal sealed class ContrastOperator : SynchronousPerturbationOperator<ContrastParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, ContrastParameters p, DeterministicTrialContext trial, CancellationToken token) =>
...
internal sealed class GammaOperator : SynchronousPerturbationOperator<GammaParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, GammaParameters p, DeterministicTrialContext trial, CancellationToken token) =>
...
internal sealed class SaturationOperator : SynchronousPerturbationOperator<SaturationParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, SaturationParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class ColorBiasOperator : SynchronousPerturbationOperator<ColorBiasParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, ColorBiasParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
        var output = source.Clone(); var bytes = output.WritableRgba;
        for (var y = 0; y < source.Size.Height; y++)
        {
