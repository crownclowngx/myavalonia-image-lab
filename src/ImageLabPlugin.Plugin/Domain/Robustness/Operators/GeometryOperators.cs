...
internal sealed class ScaleOperator : SynchronousPerturbationOperator<ScaleParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, ScaleParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class CropOperator : SynchronousPerturbationOperator<CropParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, CropParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class PadOperator : SynchronousPerturbationOperator<PadParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, PadParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class TranslateOperator : SynchronousPerturbationOperator<TranslateParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, TranslateParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class RotateOperator : SynchronousPerturbationOperator<RotateParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, RotateParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
...
internal sealed class PerspectiveOperator : SynchronousPerturbationOperator<PerspectiveParameters>
{
    ...
    protected override PixelImage Apply(PixelImage source, PerspectiveParameters p, DeterministicTrialContext trial, CancellationToken token)
    {
