...
internal sealed class RobustnessReportSerializer
{
    ...
    public string SerializeCsv(RobustnessExperimentReport report)
    {
        ...
        builder.AppendLine("schema_version,recipe_hash,profile,scan_point_index,scan_value,trial_index,completed,success,failure_reason,first_failure_step,recovered_after_failure,header_physical_ber,header_voted_ber,data_physical_ber,data_voted_ber,header_rs,data_rs,confidence,attack_psnr_y,end_to_end_psnr_y,operator_error");
