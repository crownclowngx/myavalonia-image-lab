...
internal sealed class JpegReencodeOperator(IImageCodec codec) : IImagePerturbationOperator
{
    ...
    public async ValueTask<PixelImage> ApplyAsync(PixelImage source, PerturbationParameters parameters, DeterministicTrialContext trial, CancellationToken cancellationToken)
    {
